---
title: <center><h1>LOGM 655 Student Project Report</h3></center>
...
Overall sentiment analysis for fairy tales proved fruitful. This project seperated text by Aarne-Thomspon-Uther categories, sentences within stories, and by author to explore how sentiment in fairy tales vary across topics, cultures, and throughout a story. Three lexicons, *AFINN*,  *BING*, and *NRC* were compared for assigning word sentiment. The results from the three research questions indicate that the *BING* sentiment lexicon produced the most accurate results. 
...
- Increase the sample of text in the corpus to include more 
- Using the sentiment, see if 
