...
Very generally CRF's can be thought of as F:X-->Y, a function F that maps a set of features X to the most probable tag sequence Y. The function does not act time step by step but rather acts over a window of tokens allowing it to utilize context.
